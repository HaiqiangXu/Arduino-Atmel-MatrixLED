...
public:
  ...
  */
  ...
  /**
  * Constructor. Instantiate a new instance of the class.
  */
  CLedEyes(void);

  /**
  * Destructor. Released any allocated memory and does the necessary to clean 
  ...
  */
  inline bool setText(char *pText)
  {
    if (_pText != nullptr)
      return (false);
    else
