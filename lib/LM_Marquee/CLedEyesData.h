...
const CLedEyes::animFrame_t CLedEyes::seqBlink[] PROGMEM =
{
    {{0, 0}, FRAME_TIME / 2},
    {{1, 1}, FRAME_TIME / 2},
    {{2, 2}, FRAME_TIME / 2},
...
const CLedEyes::animFrame_t CLedEyes::seqWink[] PROGMEM =
{
    {{0, 0}, FRAME_TIME / 2},
    {{1, 0}, FRAME_TIME / 2},
    {{2, 0}, FRAME_TIME / 2},
...
const CLedEyes::animFrame_t CLedEyes::seqRight[] PROGMEM =
{
    {{0, 0}, FRAME_TIME},
    {{6, 6}, FRAME_TIME},
    {{7, 7}, FRAME_TIME * 5},
...
const CLedEyes::animFrame_t CLedEyes::seqLeft[] PROGMEM =
{
    {{0, 0}, FRAME_TIME},
    {{8, 8}, FRAME_TIME},
    {{9, 9}, FRAME_TIME * 5},
...
const CLedEyes::animFrame_t CLedEyes::seqUp[] PROGMEM =
{
    {{00, 00}, FRAME_TIME},
    {{11, 11}, FRAME_TIME},
    {{12, 12}, FRAME_TIME},
...
const CLedEyes::animFrame_t CLedEyes::seqDown[] PROGMEM =
{
    {{00, 00}, FRAME_TIME},
    {{14, 14}, FRAME_TIME},
    {{15, 15}, FRAME_TIME},
...
const CLedEyes::animFrame_t CLedEyes::seqAngry[] PROGMEM =
{
    {{00, 00}, FRAME_TIME},
    {{22, 17}, FRAME_TIME},
    {{23, 18}, FRAME_TIME},
...
const CLedEyes::animFrame_t CLedEyes::seqSad[] PROGMEM =
{
    {{00, 00}, FRAME_TIME},
    {{32, 27}, FRAME_TIME},
    {{33, 28}, FRAME_TIME},
...
const CLedEyes::animFrame_t CLedEyes::seqEvil[] PROGMEM =
{
    {{00, 00}, FRAME_TIME},
    {{39, 37}, FRAME_TIME},
    {{40, 38}, 2000},
...
const CLedEyes::animFrame_t CLedEyes::seqEvil2[] PROGMEM =
{
    {{00, 00}, FRAME_TIME},
    {{54, 17}, FRAME_TIME},
    {{55, 18}, FRAME_TIME},
...
const CLedEyes::animFrame_t CLedEyes::seqSquint[] PROGMEM =
{
    {{00, 00}, FRAME_TIME},
    {{54, 54}, FRAME_TIME},
    {{55, 55}, FRAME_TIME},
...
const CLedEyes::animFrame_t CLedEyes::seqDead[] PROGMEM =
{
    {{52, 52}, FRAME_TIME * 4},
    {{53, 53}, FRAME_TIME * 4},
    {{52, 52}, FRAME_TIME * 2},
...
const CLedEyes::animFrame_t CLedEyes::seqScanLeftRight[] PROGMEM =
{
    {{41, 41}, FRAME_TIME * 2},
    {{42, 42}, FRAME_TIME},
    {{43, 43}, FRAME_TIME},
...
const CLedEyes::animFrame_t CLedEyes::seqScanUpDown[] PROGMEM =
{
    {{46, 46}, FRAME_TIME * 2},
    {{47, 47}, FRAME_TIME},
    {{48, 48}, FRAME_TIME},
...
static const CLedEyes::animTable_t CLedEyes::lookupTable[] PROGMEM =
{
    {CLedEyes::E_NEUTRAL, CLedEyes::seqBlink, 1}, // special case, fixed neutral stare
    {CLedEyes::E_BLINK, CLedEyes::seqBlink, ARRAY_SIZE(CLedEyes::seqBlink)},
    {CLedEyes::E_WINK, CLedEyes::seqWink, ARRAY_SIZE(CLedEyes::seqWink)},
    {CLedEyes::E_LOOK_L, CLedEyes::seqLeft, ARRAY_SIZE(CLedEyes::seqLeft)},
    {CLedEyes::E_LOOK_R, CLedEyes::seqRight, ARRAY_SIZE(CLedEyes::seqRight)},
    {CLedEyes::E_LOOK_U, CLedEyes::seqUp, ARRAY_SIZE(CLedEyes::seqUp)},
    {CLedEyes::E_LOOK_D, CLedEyes::seqDown, ARRAY_SIZE(CLedEyes::seqDown)},
    {CLedEyes::E_ANGRY, CLedEyes::seqAngry, ARRAY_SIZE(CLedEyes::seqAngry)},
    {CLedEyes::E_SAD, CLedEyes::seqSad, ARRAY_SIZE(CLedEyes::seqSad)},
    {CLedEyes::E_EVIL, CLedEyes::seqEvil, ARRAY_SIZE(CLedEyes::seqEvil)},
    {CLedEyes::E_EVIL2, CLedEyes::seqEvil2, ARRAY_SIZE(CLedEyes::seqEvil2)},
    {CLedEyes::E_SQUINT, CLedEyes::seqSquint, ARRAY_SIZE(CLedEyes::seqSquint)},
    {CLedEyes::E_DEAD, CLedEyes::seqDead, ARRAY_SIZE(CLedEyes::seqDead)},
    {CLedEyes::E_SCAN_LR, CLedEyes::seqScanLeftRight, ARRAY_SIZE(CLedEyes::seqScanLeftRight)},
    {CLedEyes::E_SCAN_UD, CLedEyes::seqScanUpDown, ARRAY_SIZE(CLedEyes::seqScanUpDown)},
};
