...
void CLedEyes::drawEyes(uint8_t L, uint8_t R)
...
#if DEBUG
void CLedEyes::dumpSequence(const animFrame_t* pBuf, uint8_t numElements)
...
void CLedEyes::loadFrame(animFrame_t* pBuf)
...
void CLedEyes::showText(bool bInit)
...
void CLedEyes::begin(MD_MAX72XX *M, uint8_t moduleStart)
